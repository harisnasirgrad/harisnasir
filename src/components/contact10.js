        ...
        <div className="contact10-content3 thq-flex-row">
          ...
          <div className="contact10-container4">
            ...
            <h3 className="contact10-text14 thq-heading-3">
              {props.location2 ?? (
                <Fragment>
                  <span className="contact10-text21">Admissions Office</span>
                </Fragment>
              )}
            </h3>
            <p className="thq-body-large">
...
Contact10.defaultProps = {
  content1: undefined,
  location2ImageSrc:
    'https://images.unsplash.com/photo-1584555912530-1b2c29c946e9?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MDY4MDc0MXw&ixlib=rb-4.1.0&q=80&w=1080',
  location1Description: undefined,
  location2ImageAlt: 'Admissions Office Image',
  heading1: undefined,
