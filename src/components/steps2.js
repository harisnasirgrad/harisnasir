                ...
                {props.step1Description ?? (
                  <Fragment>
                    <span className="steps2-text25">
                      Browse through a wide range of courses offered by our
                      educational institution or tutors.
                    </span>
                  </Fragment>
                )}
              </span>
                ...
                {props.step2Description ?? (
                  <Fragment>
                    <span className="steps2-text28">
                      Select the course you are interested in and complete the
                      enrollment process to secure your spot.
                    </span>
                  </Fragment>
                )}
              </span>
                ...
                {props.step3Description ?? (
                  <Fragment>
                    <span className="steps2-text26">
                      Gain access to a variety of educational resources,
                      materials, and tools to support your learning journey.
                    </span>
                  </Fragment>
                )}
              </span>
                ...
                {props.step4Description ?? (
                  <Fragment>
                    <span className="steps2-text31">
                      Begin your educational journey and enhance your skills and
                      knowledge with our courses.
                    </span>
                  </Fragment>
                )}
              </span>
